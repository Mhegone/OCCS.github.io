...
<head>
    ...
    <style>
      ...
      body {
          background-image: url('image/PlainBG1Admin.jpg');
...
<nav class="navbar navbar-expand-lg">
  ...
  <div class="collapse navbar-collapse" id="Sidebar">
    ...
    <a class="nav-item nav-link" id="NavBTN" href="homeAdmin.php">HOME</a>
      <a class="nav-item nav-link" id="NavBTN" href="FacultyAdmin.php" style="color: white;-webkit-text-stroke: transparent;">FACULTY MEMBERS</a>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content" style="background-color: #181818; border: 3px solid #f0d853; width: 80%;">
              <div class="modal-header">
                <h1 class="modal-title" style="font-size: 40px;color: #7cd175;-webkit-text-stroke: 1px black;" id="exampleModalLabel">Add Faculty Member</h1>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <select id="position" class="form-control mb-3" name="Position" style="height: 60px; width: 90%; margin-left: 25px; font-size: 20px;" required>
                            ...
                            <option value="ProgramChair">PROGRAM CHAIR(IT Dept)</option>
                            <option value="Secretary">Secretary(IT Dept)</option> 
                            <option value="FacultyProfessor1">FACULTY PROFESSOR 1</option>
                            <option value="FacultyProfessor2">FACULTY PROFESSOR 2</option>
                            <option value="FacultyProfessor3">FACULTY PROFESSOR 3</option>
                            <option value="FacultyProfessor4">FACULTY PROFESSOR 4</option>
                            <option value="FacultyProfessor5">FACULTY PROFESSOR 5</option>
                            <option value="TechSupport1">TECH SUPPORT 1</option>
                            <option value="TechSupport2">TECH SUPPORT 2</option>
                        </select>
                      </div>
                      <!-- Email -->
                      <div class="col-md-12">
                    ...
                    <button style="margin-top: 20px; -webkit-text-stroke: 1px black;color: black; font-size: 30px;background-color: #7cd175;border: 3px solid black;" class="btn w-100 py-2" type="submit" name="addFaculty">ADD PERSONNEL</button>
                  </div>
                </form>
              </div>
            </div>
  ...
  if($result->num_rows > 0){
    ...
    while($row = $result->fetch_assoc()){
        ...
        <div class="col-lg-3 mb-4 container">
            <div class="card">
                <a href="memberInfoAdmin.php?member_id=<?php echo $row['member_id']; ?>">
                    ...
                    <a href="removeMember.php?position=<?php echo $row['member_position']; ?>" onclick="return confirm('Are you sure you want to remove this member?');"><button class="btn btn-outline-danger" id="RemoveBTN">Remove Member</button></a>
                </a>
            </div>
        </div>
        <?php
