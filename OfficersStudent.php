...
<nav class="navbar navbar-expand-lg">
  ...
  <div class="collapse navbar-collapse" id="Sidebar">
    ...
    <a class="nav-item nav-link" id="NavBTN" href="homeStudent.php">HOME</a>
      <a class="nav-item nav-link" id="NavBTN" href="FacultyStudent.php">FACULTY MEMBERS</a>
      <a class="nav-item nav-link" id="NavBTN" href="OfficersStudent.php" style="color: white;-webkit-text-stroke: transparent;">STUDENT OFFICERS</a>
  ...
  if($result->num_rows > 0){
    ...
    while($row = $result->fetch_assoc()){
        ...
        <div class="col-lg-3 mb-4 container">
            <div class="card">
                <a href="officerInfoStudent.php?member_id=<?php echo $row['member_id']; ?>">
