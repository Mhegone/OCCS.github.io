...
@import url('https://fonts.googleapis.com/css2?family=Bungee&display=swap');
    body {
    height: 100%;
    background-image: url('image/HomePageBG1.jpg');
...
<nav class="navbar navbar-expand-lg">
  ...
  <div class="collapse navbar-collapse" id="Sidebar">
    ...
    <a class="nav-item nav-link" id="NavBTN" style="color: white;-webkit-text-stroke: transparent;" href="homeStudent.php">HOME</a>
